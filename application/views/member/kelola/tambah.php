...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <form class="form-horizontal" method="post" action="<?php echo base_url('admin/kelola/simpan'); ?>" enctype="multipart/form-data">
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input type="text" name="uu" class="form-control" placeholder="Nama UU" required>
              </div>
            </div>
            <div class="form-group row">
              <label for="fname" class="col-sm-3 text-right control-label col-form-label">Unggah Dokumen</label>
              <div class="col-sm-9">
                <input type="file" name="file_arsip" class="form-control" placeholder="Berkas" required accept=".pdf">
              </div>
            </div>
            <div class="form-group row">
              <label for="fname" class="col-sm-3 text-right control-label col-form-label">Tentang</label>
              <div class="col-sm-9">
                <input type="text" name="tentang" class="form-control" placeholder="Tentang Dokumen UU" required>
              </div>
            </div>
            <div class="form-group row">
