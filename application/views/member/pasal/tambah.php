...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form class="form-horizontal" method="post" action="<?php echo base_url('admin/pasal/simpan'); ?>" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="id_tbl_uu" class="form-control" placeholder="Nama UU" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="fname" class="col-sm-3 text-right control-label col-form-label">Bagian</label>
                            <div class="col-sm-9">
                                <input type="text" name="uud_id" class="form-control" placeholder="Contoh : pasal~1 ayat~1" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="fname" class="col-sm-3 text-right control-label col-form-label">Jenis Bagian</label>
                            <div class="col-sm-9">
                                <input type="text" name="uud_section" class="form-control" placeholder="Contoh : ayat" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="fname" class="col-sm-3 text-right control-label col-form-label">Bunyi</label>
                            <div class="col-sm-9">
                                <textarea id="summernote" rows="6" type="text" name="uud_content" required></textarea>
                            </div>
                        </div>
