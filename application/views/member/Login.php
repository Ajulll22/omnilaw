...
<head>
    ...
    <title>Login Aplikasi Omnilaw</title>
    <!-- Custom CSS -->
...
<body>
    <div class="main-wrapper">
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><a href="<?php echo base_url()?>/home"><h1 style="font-size: 33px; color: white;">Aplikasi Omnilaw<h1></a></span>
                    </div>
                    <!-- Form -->
        ...
        <!-- Right Sidebar -->
        <!-- ============================================================== -->
        <footer class="bg-0 text-white text-center fixed-bottom">
    <!-- Grid container -->
   <!--  <div class="container">
      
        <div class="row">
            <div class="col h-25">
                <img src="<?= base_url() ?>assets/images/lpdpunilaa.png" class="img-thumbnail" />
            </div>
        </div>
    </div> -->
    <!-- Copyright -->
    <!-- <div class="text-center p-3">
        © 2020 Copyright: LPDP Unila
    </div> -->
    <!-- Copyright -->
</footer>
<!--end footer-->
